...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-07-2019 a las 23:42:12
...
(1, 114, 'propuesta de foro', 'esta es una propuesta de foro', '2019-07-16 21:27:58', 1, 0, NULL, 'imagenes/WhatsApp Image 2019-05-22 at 19.08.5', ''),
(2, 114, 'respuesta al foro', 'esta es una respuesta al foro', '2019-07-16 21:28:44', 0, 1, NULL, 'imagenes/113-512.png', '');
...
INSERT INTO `objeto_aprendizaje` (`idobjeto_aprendizaje`, `nombre`, `descripcion`, `id_usuario`, `institucion`, `fechaCreacion`, `palabras_clave`, `tamanio`, `ruta`, `materia`, `tipo_repo`, `descarga`) VALUES
(17, 'TCP', 'Practica de la materia de TCP/IP referente al encapsulamiento de tramas, donde se usa la herramienta wireshark para capturarlas enla red.', 114, 'EPN', '2019-07-16 21:24:17', 'tcp/ip', '18422', '../../storage/TCP.sql', 'TCP-IP', 1, 0);
...
(113, 'admin', 'admin', 'ADM', 'V', 'F', ''),
(114, 'DanielTaco0', '123', 'PRO', 'V', 'F', '');
...
--
ALTER TABLE `foro`
  MODIFY `idForo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
