...
<head>
    ...
    <link rel="stylesheet"  href="styleproyecto.css"></link>
...
<div class="container-fluid text-center">
    <div class="row content">
        ...
        <div class="col-sm-12 text-center">
            ...
            <div class="container" >
                <table class="table"border ="1|1" class="table" id="tabla">
                    <thead>
                    <tr class="warning">
                        <td>Nombre</td>
                        <td>Descripción</td>
            ...
            $statement = "select * from objeto_aprendizaje where id_usuario =".$id_usuario;
