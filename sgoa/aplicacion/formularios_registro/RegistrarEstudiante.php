...
<html  lang="es">
    ...
    <body>
        ...
        <form method="post" action="ejecutar_registrar_estudiante.php"  onsubmit=" return validar_formulario_profesor()"  method="post" enctype="multipart/form-data">
            ...
            <input class="form-control" placeholder=" E-mail" id="email" type="email"required name="email"></input>
            <input class="form-control" placeholder=" Carrera"   id="carrera" type="text" required name="carrera"></br></input>
